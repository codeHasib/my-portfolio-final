...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center border-b border-gray-500 py-20">
      <motion.div
        ...
        className="relative h-[300px] w-[300px] p-[4px] rounded-full overflow-hidden bg-gray-500 "
      >
        ...
        <div className="relative h-full w-full bg-black rounded-full flex items-center justify-center text-white ">
          <div className="rounded-full flex justify-center items-center">
            <Image
              fill
              className="object-cover transition-all duration-300 hover:scale-100 rounded-full"
              src={"/myImg.png"}
